                ...
                events: {
                    load: function () {
                        ...
                        setInterval(function () {
                            var x = this.series[0].x, // current time
                            console.log(this.series[0].x);
                                y = this.series[0].y;
			...
			series: [{
                ...
                data: (function () {
                    ...
                    for (record in records) {
                        data.push([
                            x: parseInt(records[record].memory_stats[0].usage),
                            y: parseInt(records[record].memory_stats[0].max_usage)
                        ]);
                    }
                    console.log(data);
                    return data;
