...
//    var xAxis = d3.svg.axis().scale(x).orient("bottom");
    ...
    var area1 = d3.area().x(function (d) { return x(d.t); }).y0(height).y1(function (d) { return y1(d.health); });
    var area2 = d3.area().x(function (d) { return x(d.t); }).y0(height).y1(function (d) { return y2(d.errorCount); });
    var area3 = d3.area().x(function (d) { return x(d.t); }).y0(height).y1(function (d) { return y3(d.errorDeviation); });
    var area4 = d3.area().x(function (d) { return x(d.t); }).y0(height).y1(function (d) { return y4(d.responseTime); });
    
    var line1 = d3.line().x(function (d) { return x(d.t); }).y(function (d) { return y1(d.health); });
    var line2 = d3.line().x(function (d) { return x(d.t); }).y(function (d) { return y2(d.errorCount); });
    var line3 = d3.line().x(function (d) { return x(d.t); }).y(function (d) { return y3(d.errorDeviation); });
    var line4 = d3.line().x(function (d) { return x(d.t); }).y(function (d) { return y4(d.responseTime); });
